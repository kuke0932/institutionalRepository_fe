      ...
      'data': [
        {
          ...
          'children': [
            ...
            {
              'path': 'systemManagement/group/viewUser',
              'component': 'systemManagement/group/viewUser',
              'name': '群组管理',
        ...
        // 公文管理
        {
          ...
          'component': '',
          'name': '任务管理',
          'meta': { 'icon': 'taskManage', 'title': '任务管理', 'role': null, 'functionType': 1 },
          'children': [
            {
              'path': 'taskFlow/index',
              'component': 'taskFlow/index',
              'name': '任务流程',
              'meta': { 'icon': 'file', 'title': '任务流程', 'role': null, 'functionType': 1 },
              'children': [
                {
                  'path': '',
                  'component': '',
                  'name': '查询',
                  'meta': { 'icon': null, 'title': '查询', 'functionType': 2, 'code': 'del' },
                  'children': [],
                  'hidden': true
                },
                {
                  ...
                  'component': '',
                  'name': '起草',
                  'meta': { 'icon': null, 'title': '起草', 'functionType': 2, 'code': 'add' },
                  'children': [],
                  'hidden': true
                }]
            },
            {
              ...
              'component': '',
              'name': '查询任务',
              'meta': { 'icon': 'search', 'title': '查询任务', 'role': null, 'functionType': 1 },
              'children': [{
                'path': 'taskQuery/index',
                'component': 'taskQuery/index',
                'name': '查询所有任务',
                'meta': { 'icon': 'file', 'title': '查询所有任务', 'role': null, 'functionType': 1 },
                'children': [
                  {
                    'path': '',
                    'component': '',
              ...
              {
                'path': 'documentDraft/index',
                'component': 'documentDraft/index',
                'name': '已审批任务',
                'meta': { 'icon': 'file', 'title': '已审批任务', 'role': null, 'functionType': 1 },
                'children': [
                  {
                    'path': '',
                    'component': '',
