<template>
  <div class="container" style="margin-top: 20px;">
    <div class="btn_box" style="margin-bottom:15px" v-if="name == 'admin'">
      ...
      <el-button type="primary" size="small" code="updateFolderSort" :disabled="editDisabled" @click="updateFolderSort">修改文件夹顺序</el-button>
      <el-button type="primary" size="small" code="folderRename" :disabled="editDisabled" @click="folderRename">重命名文件夹</el-button>
    ...
    <div class="btn_box top" style="margin-bottom:15px" v-else>
      ...
      <el-button type="primary" class="hidden" size="small" code="updateFolderSort" :disabled="editDisabled" @click="updateFolderSort">修改文件夹顺序</el-button>
      <el-button type="primary" class="hidden" size="small" code="folderRename" :disabled="editDisabled" @click="folderRename">重命名文件夹</el-button>
...
<script>
  ...
  import { treeFolder, getFolderById, folderRename, updateFolderSort, removeFolder } from '@/api/folder'
