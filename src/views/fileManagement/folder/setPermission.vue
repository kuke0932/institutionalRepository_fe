          ...
          <el-form>
            ...
            <div class="btn_box" style="">
              ...
              <el-dialog
                ...
                append-to-body
                :before-close="handleClose">
                <el-button class="el-button--primary" style="margin:0 0px 15px 0; " @click="addGroup">保存</el-button>
                <el-row>
                  <el-col :span="8">
                    <el-form-item label-width="70px" label="群组名">
...
<script>
  ...
  import { listAddRole, listAddGroup, setFolderPermission,
  ...
  export default {
    ...
    methods: {
      ...
      /* 获取所有数据 */
      fetchData() {
        this.fetchRoleData(this.parentFolder.id, null, null)
        this.fetchDepartmentData(this.parentFolder.id, null, null)
        this.fetchGroupData(this.parentFolder.id, null)
      },
      ...
      submit() {
        ...
        setFolderPermission(this.parentFolder.id, roleList, departmentList, groupList).then(() => {
          this.$message({
            type: 'success',
            message: '设置成功',
            duration: 2000,
