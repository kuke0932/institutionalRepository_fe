<template>
  <div class="container" style="margin-top: 0">
    <el-button type="primary" style="margin-bottom: 10px;" @click="submit()">保存权限</el-button>
          ...
          <el-form>
            ...
            <div class="btn_box" style="">
              ...
              <el-dialog
                ...
                <el-button class="el-button--primary" style="margin:0 0px 15px 0; " @click="addRole">保存</el-button>
                <el-row>
                  <el-col :span="8">
                    <el-form-item label-width="70px" label="角色名">
          ...
          <el-form>
            ...
            <div class="btn_box" style="">
              ...
              <el-dialog
                ...
                append-to-body
                :before-close="handleClose">
                <el-button class="el-button--primary" style="margin:0 0px 15px; " @click="addDepartment">保存</el-button>
                <el-tree
                  :data="treeDepartment"
                  ref="treeDepartment"
                  highlight-current
          ...
          <el-form>
            ...
            <div class="btn_box" style="">
              ...
              <el-dialog
                ...
                append-to-body
                :before-close="handleClose">
                <el-button class="el-button--primary" style="margin:0 0px 15px; " @click="addGroup">保存</el-button>
                <el-row>
                  <el-col :span="8">
                    <el-form-item label-width="70px" label="群组名">
...
<script>
  ...
  import { listAddRole, listAddGroup } from '@/api/folder'
  import { setFilePermission, showAllFileRole, showAllFileDepartment, showAllFileGroup } from '@/api/file'
  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        setFilePermission(this.fileId, roleList, departmentList, groupList).then(() => {
          this.$message({
            type: 'success',
            message: '设置成功',
            duration: 2000,
