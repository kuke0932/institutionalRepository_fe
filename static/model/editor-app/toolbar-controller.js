'use strict';
angular.module('activitiModeler').controller('ToolbarController', ['$scope', '$http', '$modal', '$q', '$rootScope', '$translate', '$location', function ($scope, $http, $modal, $q, $rootScope, $translate, $location) {
  ...
  // Click handler for toolbar buttons 单击工具栏按钮的处理程序
  $scope.toolbarButtonClicked = function (buttonIndex) {
    // Default behaviour 违约行为
